		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#logaligroupinvoicesjhoan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupinvoicesjhoan-display": {
								"semanticObject": "logaligroupinvoicesjhoan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.invoicesjhoan",
									"url": sap.ui.require.toUrl("logaligroup/invoicesjhoan")
								}
							}
						}
					}
